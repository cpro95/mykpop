...
//         {SettingSVG}
//       </Menu.Button>
//       <Menu.Items className="right-0 mt-2 w-40 origin-top-right rounded-md bg-dodger-50 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-dodger-600">
//         {email !== undefined ? (
//           <>
//             <Menu.Item
//             // onSelect={() => null}
//             >
//               <p className="block w-full bg-dodger-50 px-4 py-2 text-left text-sm text-black dark:bg-dodger-600 dark:text-white">
//                 Hello! {email}
//               </p>
//             </Menu.Item>
//             <Menu.Item>
...
//           </>
//         ) : (
//           <Menu.Item as="a" href="/login" className={menuItemStyle}>
//             Sign in
//           </Menu.Item>
//         )}

//         <Menu.Item as="a" href="/users" className={menuItemStyle}>
//           Settings
//         </Menu.Item>
//       </Menu.Items>
//     </Menu>
