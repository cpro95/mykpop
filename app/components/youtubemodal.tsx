        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="m-2 flex flex-col items-center justify-center p-4 text-center">
            ...
            >
              ...
              <Dialog.Panel className="relative mx-auto w-full max-w-4xl transform rounded-2xl p-2 pt-8 shadow-xl transition-all md:p-6">
                <button
                ...
                */}
                ...
                >
                  <span className="leading-6">{video?.youtubeTitle}</span>
                  <div className="mt-5 flex flex-col items-center justify-center gap-x-3 gap-y-3 text-sm md:flex-row">
                    <div className="rounded border border-white/40 py-1 px-1.5 text-xs font-bold text-gray-300">
                      YOUTUBE
                    </div>
