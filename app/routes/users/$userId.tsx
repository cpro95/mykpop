...
import { toggleUserRole } from "~/models/user.server";
      ...
      <div className="mt-4 space-y-4">
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
            <thead className="bg-dodger-50 text-xs uppercase text-gray-700 dark:bg-dodger-800 dark:text-gray-400">
              <tr>
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
            <thead className="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-dodger-800 dark:text-gray-400">
              <tr>
                <th scope="col" className="px-6 py-3">
                  Created At
                </th>
            ...
            <tbody>
              <tr className="bg-dodger-50 dark:bg-gray-800">
