...
export default function ChangePassword() {
  ...
  return (
    <div className="flex w-full max-w-md flex-col justify-start rounded-md bg-dodger-50 p-6 shadow-md dark:bg-dodger-800">
      {fetcher?.data?.message && (
        ...
        <div>
          ...
          <div className="mt-1">
            ...
            <input
              ...
              type="password"
              required
              className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-500 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400"
            />
